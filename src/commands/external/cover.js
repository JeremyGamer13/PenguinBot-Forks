...
class Command {
    ...
    async handle(message, args, util) {
        ...
        await temporaryFolder.createAndDestroy(async (tempDir) => {
            ...
            if (true) { // NOTE: maybe ill add some condition later but honestly even i should approve my own audios i might forget
                await replyMessage.edit("# This command requires approval."
            ...
            const outputPathAICover = path.join(tempDir, "ai_cover_jeremy.ogg");
