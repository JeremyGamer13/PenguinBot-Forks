...
const activeTimestamp = 1782313200000;
    ...
    invoke(message) {
        ...
        message.reply({
            content: difference <= 0 ? `wha? whatre you doing-its ITS RIGHT NOW DELTARUNE NOW <:glee:1505817436895707288><:glee:1505817436895707288><:glee:1505817436895707288>`
                : `Deltarune chapter 5 is in ${FormatTime.formatTime(difference)} (specifically, its happening on <t:${activeTimestamp / 1000}:s> <t:${activeTimestamp / 1000}:R>)`,
            allowedMentions: {
                parse: [],
                users: [],
                roles: [],
